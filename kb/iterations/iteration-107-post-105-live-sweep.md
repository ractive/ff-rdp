---
title: "Iteration 107: post-105 full live-suite sweep — run everything against real Firefox once, fix all fallout"
type: iteration
date: 2026-07-09
status: planned
branch: iter-107/post-105-live-sweep
depends_on:
  - kb/iterations/iteration-105-error-taxonomy-release-prep.md
...
# Iteration 107 — post-105 full live-suite sweep

## Motivation

Per James's 2026-07-09 decision, iterations 102–105 do NOT run the full live
...
For every failure:
- If caused by an iteration in the 101–105 range: fix it in this iteration.
...
- New live tests introduced by 101–105 whose full-suite interaction was never
...
- [ ] full_sweep_recorded: complete `cargo test-live` inventory (pass/fail per
      test) attached to Results, run on post-105 main.
