---
title: "Iteration 182: 246 e2e-tier assertions still report only stderr, so their failure messages ship empty"
type: iteration
date: 2026-08-22
status: planned
...
dogfood_path: |
  ...
  #    Measured 2026-08-22: 246 offending invocations under tests/e2e/.
...
than the live tier's `common`, so it needs its own `output_note` equivalent; and 246 further
...
- **B — Rewrite the 246 sites and widen the guard.** Adding
