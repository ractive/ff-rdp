...
| 4 | A completed sweep's real-root orphan guarantee is still unasserted | **already filed**, [[iteration-245-live-sweep-lost-its-real-root-orphan-guarantee]]. This iteration's reaper only runs on the timeout path, by design — it does not close 202. |
