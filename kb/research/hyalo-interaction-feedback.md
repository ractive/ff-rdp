...
## September20 foundation262 integration

Hyalo0.24.1 body and body-range reads recovered the preserved plan and required
research guidance. Broad combined outputs exceeded the caller's output budget;
narrower reads recovered those sections. This is caller truncation, not a Hyalo
defect. Append-only feedback merge conflicts retained both histories using the
unsupported prose-edit allowance. No ../hyalo edits or benchmarks were performed.
